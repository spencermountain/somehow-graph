...
(function (global){
!function a(o,s,d){function c(i,e){if(!s[i]){if(!o[i]){var t="function"==typeof _dereq_&&_dereq_;if(!e&&t)return t(i,!0);if(p)return p(i,!0);var n=new Error("Cannot find module '"+i+"'");throw n.code="MODULE_NOT_FOUND",n}var r=s[i]={exports:{}};o[i][0].call(r.exports,function(e){return c(o[i][1][e]||e)},r,r.exports,a,o,s,d)}return s[i].exports}for(var p="function"==typeof _dereq_&&_dereq_,e=0;e<d.length;e++)c(d[e]);return c}({1:[function(e,i,t){"use strict";var n=[{names:["square","1:1","instagram"],description:"Square",decimal:1,orientation:"landscape"},{names:["4:3","fullscreen","four three","1.33:1","ipad","pythagorean"],description:"Traditional TVs",decimal:1.333333,orientation:"landscape"},{names:["a4","√2:1","paper","lichtenberg","1:1.41"],description:"A4 paper",decimal:1.41},{names:["imax","1.43:1"],description:"IMAX film",decimal:1.43,orientation:"landscape"},{names:["3:2","35mm","photo","1.5:1","1.5"],description:"35mm photos",decimal:1.5,orientation:"landscape"},{names:["business card","bank card","1.58:1"],description:"Bank Cards",decimal:1.58577,orientation:"landscape"},{names:["golden","kepler","1.618","1.6:1"],description:"Golden ratio",decimal:1.61803,orientation:"landscape"},{names:["16:9","hd","hdtv","fhd","tv","computer","iphone","4k","8k","1.78:1"],description:"HD video",decimal:1.77777,orientation:"landscape"},{names:["widescreen","1.85:1"],description:"Movie-theatres",decimal:1.85,orientation:"landscape"},{names:["2:1","univisium","mobile","18:9"],description:"2:1",decimal:2,orientation:"landscape"},{names:["cinemascope","widescreen","wide","2.35:1","2.39:1"],description:"Widescreen",decimal:2.35,orientation:"landscape"},{names:["silver","1 + √2","2.41:1"],description:"Silver ratio",decimal:2.41,orientation:"landscape"}],r=n.map(function(e){return(e=Object.assign({},e)).decimal=1/e.decimal,e.orientation="portrait",e}),a={};n.forEach(function(i){i.names.forEach(function(e){a[e]=i})}),i.exports={lookup:a,portraits:r,list:n}},{}],2:[function(e,i,t){"use strict";var n=e("./aspects");i.exports=function(e,i){var t=e/i;return(t=parseInt(100*t,10)/100)<1?function(e,i){for(var t=0;t<i.length;t+=1)if(e>i[t].decimal){if(i[t-1]){var n=Math.abs(e-i[t].decimal);if(Math.abs(e-i[t-1].decimal)<n)return i[t-1]}return i[t]}return i[i.length-1]}(t,n.portraits):function(e,i){for(var t=0;t<i.length;t+=1)if(e<=i[t].decimal){if(i[t-1]){var n=Math.abs(e-i[t].decimal);if(Math.abs(e-i[t-1].decimal)<n)return i[t-1]}return i[t]}return i[i.length-1]}(t,n.list)}},{"./aspects":1}],3:[function(t,n,e){(function(e){"use strict";var u=t("./find-best-ratio"),f=t("./parse-ratio"),i=function(){var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};if("number"==typeof e.width&&"number"==typeof e.height){var i=u(e.width,e.height),t=1/i.decimal,n=e.width*t,r=(n-e.height)/e.height;return r=parseInt(1e3*r,10)/10,n=Math.round(n),{aspect:i,percent_change:r,width:e.width,height:n}}var a=f(e.aspect||e.ratio||"");if(null===a)return console.error("find-aspect-ratio error: Could not find a given aspect ratio."),e;if("number"==typeof e.width){var o=1/a.decimal,s=e.orientation||"landscape";"portrait"===s&&(o=1/o);var d=e.width*o;return d=Math.round(d),{aspect:a,width:e.width,height:d,orientation:s}}if("number"!=typeof e.height)return console.error("find-aspect-ratio error: Please supply a height, width, or ratio value."),e;var c=a.decimal,p=e.orientation||"landscape";"portrait"===p&&(c=1/c);var l=e.height*c;return{aspect:a,width:l=Math.round(l),height:e.height,orientation:p}};"undefined"!=typeof self?self.nlp=i:"undefined"!=typeof window?window.nlp=i:void 0!==e&&(e.nlp=i),"function"==typeof define&&define.amd&&define(i),void 0!==n&&(n.exports=i)}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"./find-best-ratio":2,"./parse-ratio":4}],4:[function(e,i,t){"use strict";var n=e("./aspects"),r=/^[0-9\.]+:[0-9\.]+$/;i.exports=function(e){if(e=(e=(e=(e=e.toLowerCase()).trim()).replace(" ratio","")).replace("-"," "),!0===n.lookup.hasOwnProperty(e))return n.lookup[e];if(!0!==r.test(e))return null;var i=e.split(":");return{description:"custom",decimal:parseFloat(i[0])/parseFloat(i[1])}}},{"./aspects":1}]},{},[3]);
...
!function o(i,u,s){function a(r,e){if(!u[r]){if(!i[r]){var t="function"==typeof _dereq_&&_dereq_;if(!e&&t)return t(r,!0);if(f)return f(r,!0);var c=new Error("Cannot find module '"+r+"'");throw c.code="MODULE_NOT_FOUND",c}var n=u[r]={exports:{}};i[r][0].call(n.exports,function(e){return a(i[r][1][e]||e)},n,n.exports,o,i,u,s)}return u[r].exports}for(var f="function"==typeof _dereq_&&_dereq_,e=0;e<s.length;e++)a(s[e]);return a}({1:[function(e,r,t){"use strict";var c=e("./src");console.log(c);var n=document.querySelector("#stage"),o=Object.keys(c).map(function(e){return"black"===e||"white"===e?"":'<div class="w6 h4 rounded" style="background-color:'.concat(c[e],'; "></div>')}).join("");n.innerHTML=o},{"./src":4}],2:[function(e,r,t){"use strict";r.exports={blue:"#6699cc",green:"#6accb2",yellow:"#e1e6b3",red:"#cc7066",pink:"#e6b8b3",brown:"#9c896c",orange:"#cc8a66",purple:"#d8b3e6",navy:"#335799",olive:"#7f9c6c",burnt:"#603a39",beige:"#e6d7b3",fuscia:"#603960"}},{}],3:[function(e,r,t){"use strict";r.exports={white:"#fbfbfb",grey:"#4d4d4d",dim:"#d7d5d2",lightgrey:"#949a9e",dark:"#443d3d",bluegrey:"#606c74",black:"#333333"}},{}],4:[function(e,r,t){"use strict";var c=e("./greys"),n=e("./colors");r.exports=Object.assign({},n,c)},{"./colors":2,"./greys":3}]},{},[1]);
...
function () {
  ...
  _createClass(World, [{
    ...
    value: function build() {
      ...
      this.el.innerHTML = "<svg ".concat(attrs, ">").concat(elements, "</svg>");
    }
  }]);
...
},{"./axis/XAxis":18,"./axis/YAxis":19,"./methods":22,"./scales/Scale":24,"./scales/YScale":25,"./shapes/Dot":26,"./shapes/Line":27,"./shapes/Shape":28,"./shapes/Text":29,"fit-aspect-ratio":11}],16:[function(_dereq_,module,exports){
"use strict";
...
},{"./_ticks":20}],18:[function(_dereq_,module,exports){
"use strict";
  ...
  _createClass(XAxis, [{
    ...
    value: function drawTicks(y) {
      ...
      return this.ticks().map(function (o) {
        return "<text x=\"".concat(o.pos, "\" y=\"").concat(y + 15, "\" fill=\"").concat(_this2.attrs.stroke, "\" text-anchor=\"middle\" style=\"font-size:12px;\">\n        ").concat(o.label, "\n      </text>");
      });
    }
  }, {
    key: "build",
    value: function build() {
      ...
      return "<g>\n      ".concat(ticks, "\n      <line x1=\"", 0, "\" y1=\"").concat(y, "\" x2=\"").concat(width, "\" y2=\"").concat(y, "\" ").concat(attrs, "/>\n    </g>");
    }
  }]);
...
function (_Axis) {
  ...
  _createClass(YAxis, [{
    ...
    value: function drawTicks(x) {
      ...
      return this.ticks().map(function (o) {
        return "<text x=\"".concat(x, "\" y=\"").concat(o.pos, "\" dy=\"0\" dx=\"-6\" fill=\"").concat(_this2.attrs.stroke, "\" text-anchor=\"end\" style=\"font-size:12px;\">\n        ").concat(o.label, "\n      </text>");
      });
    }
  }, {
    key: "build",
    value: function build() {
      ...
      return "<g>\n      ".concat(ticks, "\n      <line x1=\"").concat(x, "\" y1=\"", 0, "\" x2=\"").concat(x, "\" y2=\"").concat(height, "\" ").concat(attrs, "/>\n    </g>");
    }
  }]);
...
var chooseFmt = function chooseFmt(scale) {
  var min = spacetime(scale.min);
  var max = spacetime(scale.max);
  var diff = min.diff(max);
...
},{"spacetime":13}],21:[function(_dereq_,module,exports){
"use strict";
...
},{"./World":15}],22:[function(_dereq_,module,exports){
"use strict";
...
},{"./_fns":16,"./parse":23}],23:[function(_dereq_,module,exports){
"use strict";
...
},{"spacetime":13}],24:[function(_dereq_,module,exports){
"use strict";
...
},{"../parse":23,"d3-scale":7}],25:[function(_dereq_,module,exports){
"use strict";
...
},{"../parse":23,"./Scale":24,"d3-scale":7}],26:[function(_dereq_,module,exports){
"use strict";
...
},{"./Shape":28,"spencer-color":14}],27:[function(_dereq_,module,exports){
"use strict";
...
},{"./Shape":28,"d3-shape":8,"spencer-color":14}],28:[function(_dereq_,module,exports){
"use strict";
...
function () {
  ...
  _createClass(Shape, [{
    ...
    value: function build() {
      ...
      return "<path ".concat(attrs, " style=\"").concat(this.drawSyle(), "\"/>");
    }
  }]);
...
},{"../_fns":16,"./lib/parseInput":30,"flubber":12,"spencer-color":14}],29:[function(_dereq_,module,exports){
"use strict";
...
var defaults = {
  ...
  stroke: 'none',
  'stroke-width': 1,
  'stroke-linecap': 'round' // const defaultPoint = {
  //   x: '50%',
  //   y: '50%',
  // }
...
function (_Shape) {
  ...
  _createClass(Text, [{
    ...
    key: "underline",
    value: function underline(color) {
      var size = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 2;
      this.style['border-bottom'] = "".concat(size, "px solid ").concat(color);
      return this;
    }
  }, {
    key: "extent",
    ...
    value: function build() {
      var inside = this.textLines.map(function (str) {
        return "<tspan x=\"0\" dy=\"1.2em\">".concat(str, "</tspan>");
      });
      inside = inside.join('\n');
      var point = this.points()[0];
      ...
      var y = point[1] - height + (this._dodge.y || 0);
      var x = point[0] + 2 + (this._dodge.x || 0);
      return "<g transform=\"translate(".concat(x, " ").concat(y, ")\" style=\"").concat(this.drawSyle(), "\">\n      <text ").concat(attrs, ">\n        ").concat(inside, "\n      </text>\n    </g>");
    }
  }]);
...
},{"./Shape":28,"spencer-color":14}],30:[function(_dereq_,module,exports){
"use strict";
