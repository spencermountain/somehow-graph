...
var World = function () {
  ...
  _createClass(World, [{
    key: 'add',
    value: function add(str, obj) {
      var shape = makeShape(str, obj, this);
    ...
    value: function render() {
      ...
      var elements = shapes.reduce(function (str, shape) {
...
Object.keys(aliases).forEach(function (k) {
  return Scale.prototype[k] = Scale.prototype[aliases[k]];
});
...
var makeShape = function makeShape(str, obj, world) {
  ...
  _createClass(Rect, [{
    ...
    value: function makePath() {
      ...
      return d3Shape.line().x(function (d) {
        ...
        return d.y;
      })(points); //.curve(d3Shape.curveMonotoneX)
    }
  }, {
    key: 'render',
    value: function render() {
