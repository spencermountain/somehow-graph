(function (global, factory) {
  ...
  var toString$1 = function toString(d) {
  ...
  var shouldChange$1 = function shouldChange(epoch, start, end, defaultOffset) {
    ...
    d = new Date(epoch + shift);
    var current = toString$1(d); //eg. is it after ~november?
  ...
  var summerTime$1 = shouldChange$1; // this method avoids having to do a full dst-calculation on every operation
  // it reproduces some things in ./index.js, but speeds up spacetime considerably
  ...
  var unpack$1 = all$1; //find the implicit iana code for this machine.
  //safely query the Intl object
  //based on - https://bitbucket.org/pellepim/jstimezonedetect/src
  ...
  var milliseconds$1 = o$1; //basically, step-forward/backward until js Date object says we're there.
  ...
  function buildMapping$1() {
    ...
    for (var _i2 = 0; _i2 < shortMonths$1.length; _i2++) {
      obj[shortMonths$1[_i2]] = _i2;
    }

    for (var _i3 = 0; _i3 < longMonths$1.length; _i3++) {
      obj[longMonths$1[_i3]] = _i3;
    }
  ...
  var parseOffset$1$1 = function parseOffset$1(s, offset) {
    if (!offset) {
      return s;
    } //this is a fancy-move
  ...
  var namedDates$1 = dates$1; //we have to actually parse these inputs ourselves
  //  -  can't use built-in js parser ;(
  //=========================================
  // ISO Date	  "2015-03-25"
  // Short Date	"03/25/2015" or "2015/03/25"
  ...
  var handleArray$1 = function handleArray(s, arr) {
    var order = ['year', 'month', 'date', 'hour', 'minute', 'second', 'millisecond'];

    for (var _i4 = 0; _i4 < order.length; _i4++) {
      var _num2 = arr[_i4] || defaults$1[order[_i4]] || 0;
  ...
  var handleObject$1 = function handleObject(s, obj) {
    ...
    for (var _i5 = 0; _i5 < keys.length; _i5++) {
      ...
      var _num3 = obj[unit] || defaults$1[unit] || 0;
  ...
  var parseInput$1 = function parseInput(s, input, givenTz) {
    ...
    for (var _i6 = 0; _i6 < strParse$1.length; _i6++) {
      var m = input.match(strParse$1[_i6].reg);

      if (m) {
        s = strParse$1[_i6].parse(s, m, givenTz);
        return s;
      }
    }
  ...
  var progress_1$1 = progress$1; //round to either current, or +1 of this unit
  ...
  var nearest_1$1 = nearest$1; //increment until dates are the same
  ...
  var one$1 = diffOne$1; // don't do anything too fancy here.
  // 2020 - 2019 may be 1 year, or 0 years
  // - '1 year difference' means 366 days during a leap year
  ...
  var diff$1$1 = main$2; //by spencermountain + Shaun Grady
  //our conceptual 'break-points' for each unit
  ...
  var since_1$1 = since$1; //https://www.timeanddate.com/calendar/aboutseasons.html
  // Spring - from March 1 to May 31;
  // Summer - from June 1 to August 31;
  // Fall (autumn) - from September 1 to November 30; and,
  // Winter - from December 1 to February 28 (February 29 in a leap year).
  ...
  var units$2$1 = {
    ...
    season: function season(s) {
      ...
      for (var _i9 = 0; _i9 < seasons$1[hem].length; _i9++) {
        if (seasons$1[hem][_i9][0] === current) {
          //winter goes between years
          var year = s.year();
          ...
          walk_1$1(s, {
            year: year,
            month: seasons$1[hem][_i9][1],
            date: seasons$1[hem][_i9][2],
            hour: 0,
            minute: 0,
            second: 0,
            millisecond: 0
  ...
  var timezone_1$1 = timezone$1; //the spacetime instance methods (also, the API)
  ...
  var methods$6 = {
    ...
    weekStart: function weekStart(input) {
      ...
      if (typeof input === 'string') {
        ...
        var _num4 = days$1["short"]().indexOf(input);

        if (_num4 === -1) {
          _num4 = days$1["long"]().indexOf(input);
        }
  ...
  var methods_1$2 = methods$6; // javascript setX methods like setDate() can't be used because of the local bias
  //these methods wrap around them.
  ...
  var set$1 = {
    ...
    date: function date(s, n) {
      ...
      if (n > 28) {
        var max = monthLengths_1$1[s.month()];
  ...
  var methods$3$1 = {
    ...
    quarter: function quarter(num) {
      ...
      for (var _i12 = 1; _i12 < quarters$1.length; _i12++) {
        if (month < quarters$1[_i12][0]) {
          return _i12 - 1;
        }
      }
    ...
    season: function season(input) {
      ...
      if (input !== undefined) {
        ...
        for (var _i13 = 0; _i13 < seasons$1[hem].length; _i13++) {
          if (input === seasons$1[hem][_i13][0]) {
            s = s.month(seasons$1[hem][_i13][1]);
            s = s.date(1);
            s = s.startOf('day');
          }
        }
      ...
      for (var _i14 = 0; _i14 < seasons$1[hem].length - 1; _i14++) {
        if (month >= seasons$1[hem][_i14][1] && month < seasons$1[hem][_i14 + 1][1]) {
          return seasons$1[hem][_i14][0];
        }
      }
  ...
  var addMethods$1$1 = function addMethods$1(SpaceTime) {
    SpaceTime.prototype.add = function (num, unit) {
      var s = this.clone();
  ...
  var add$1 = addMethods$1$1; //make a string, for easy comparison between dates
  ...
  var addMethods$2$1 = function addMethods$2(SpaceTime) {
    SpaceTime.prototype.isSame = function (b, unit) {
      var a = this;
  ...
  var addMethods$3$1 = function addMethods$3(SpaceTime) {
    var methods = {
      isAfter: function isAfter(d) {
  ...
  var addMethods$4$1 = function addMethods$4(SpaceTime) {
    var methods = {
      i18n: function i18n(data) {
        //change the day names
  ...
  Object.keys(methods_1$2).forEach(function (k) {
  ...
  i18n$1(SpaceTime$1);
  var spacetime$3 = SpaceTime$1; // const timezones = require('../data');

  var whereIts$1 = function whereIts(a, b) {
    var start = new spacetime$3(null);
    var end = new spacetime$3(null);
    start = start.time(a); //if b is undefined, use as 'within one hour'
  ...
  var main$1$1 = function main$1(input, tz, options) {
    return new spacetime$3(input, tz, options);
  }; //some helper functions on the main method


  main$1$1.now = function (tz, options) {
    return new spacetime$3(new Date().getTime(), tz, options);
  };

  main$1$1.today = function (tz, options) {
    var s = new spacetime$3(new Date().getTime(), tz, options);
    return s.startOf('day');
  };
  ...
  var _reduce = reduceTo; //increment by this unit
  ...
  var spacetimeTicks = function spacetimeTicks(start, end) {
    ...
    end = spacetime$2$1(end); //reverse them, if necessary
  ...
  var date = function date(axis) {
    ...
    var start = scale.min || 0;
    var end = scale.max || 0;
    var ticks = spacetimeTicks$2(start, end, n);
    return ticks;
  };
    ...
    _createClass(XAxis, [{
      ...
      value: function drawTicks(y) {
        ...
        return this.ticks().map(function (o) {
          console.log(o.label);
          return h(_templateObject(), o.value * 100 + '%', y + 5, _this2.attrs.stroke, o.label);
        });
      }
    }, {
      key: "build",
  ...
  var parseInput$2 = function parseInput(set, world) {
  ...
  var d3Shape = getCjsExportFromNamespace(src$2);
  ...
  function (_Text) {
    ...
    function Annotation() {
      ...
      _this.attrs = Object.assign({}, defaults$9, _this.attrs);
      _this._nudge = {
        x: 0,
        y: 0
      };
