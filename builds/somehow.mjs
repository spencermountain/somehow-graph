...
class Annotation extends Text_1 {
  constructor(obj = {}, world) {
    super(obj, world);
    this.attrs = Object.assign({}, defaults$7, this.attrs);
    this._nudge = {
      x: 0,
      y: 0
    };
